...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.sc_port = QtWidgets.QComboBox(self.port_groupbox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.sc_port.sizePolicy().hasHeightForWidth())
        self.sc_port.setSizePolicy(sizePolicy)
        self.sc_port.setObjectName("sc_port")
        self.horizontalLayout.addWidget(self.sc_port)
        ...
        self.ub_port = QtWidgets.QComboBox(self.port_groupbox)
